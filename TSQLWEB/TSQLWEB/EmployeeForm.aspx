        ...
        <tr>
            ...
            <td class="form_right">
                ...
                <asp:Textbox cssClass="form-control" ID="txtBirthDate" runat="server" />
                    <div>
                <img ID="CalendarPopUp11" width="40px" Class="img-rounded popup_icon" src="image/calendar.png" />
                <ajaxToolkit:CalendarExtender ID="txtBirthDate_CalendarExtender" runat="server" TargetControlID="txtBirthDate" PopupButtonID="CalendarPopUp11"/>
                   </div>
            </td>
        </tr>
        <tr>
            ...
            <td class="form_right">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Input Hiredate" ControlToValidate="txtHireDate" ForeColor="Red"/>
                 <asp:Textbox cssClass="form-control" ID="txtHireDate" runat="server" />
                    <div>
                <img ID="CalendarPopUp22" width="40px" Class="img-rounded popup_icon" src="image/calendar.png" />
                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtHireDate" PopupButtonID="CalendarPopUp22"/>
                   </div>
            </td>
        </tr>
        <tr>
...
<asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateDeleteButton="True" AutoGenerateSelectButton="True" OnRowDeleting="GridView1_RowDeleting">
